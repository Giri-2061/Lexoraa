    ...
    <LegalLayout title="Privacy Policy">
      ...
      <section className="mb-8">
        ...
        <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400 mt-4">
          <h3 className="font-semibold text-blue-900 mb-2">AI Processing Note</h3>
          <p className="text-blue-800">
            Data sent to OpenAI and Groq via API is used exclusively for real-time evaluation of your test submissions and is not used by these providers to train their public AI models. Your data remains private and is not incorporated into their training datasets.
          </p>
        </div>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">Service Providers</h2>
        <p>
          We use the following third-party service providers to operate and maintain our platform:
        </p>
        <ul className="list-disc list-inside mt-4 space-y-2">
          <li><strong>Supabase:</strong> For secure database storage, user authentication, and file storage (including audio recordings).</li>
          <li><strong>Sentry:</strong> For technical error monitoring and performance tracking to help us maintain platform reliability.</li>
        </ul>
        <p>
          These providers are contractually obligated to maintain the confidentiality and security of your data and may only use it for the purposes specified in our agreements with them.
        </p>
      </section>
